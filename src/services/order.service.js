...
const allowedFromByAction = {
  ...
  technician_arrived: [ORDER_STATUS.ASSIGNED],
  submit_quote: [ORDER_STATUS.ARRIVED],
  ...
  submit_change_request: [ORDER_STATUS.IN_PROGRESS],
  technician_complete: [ORDER_STATUS.IN_PROGRESS],
