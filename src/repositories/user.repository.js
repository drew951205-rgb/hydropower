...
async function findOrCreateByLineUserId(lineUserId, defaults = {}) {
  ...
  const payload = {
    ...
    line_display_name: defaults.line_display_name || null,
    line_picture_url: defaults.line_picture_url || null,
    line_language: defaults.line_language || null,
    default_address: defaults.default_address || null,
    preferred_area: defaults.preferred_area || null,
    available_time_text: defaults.available_time_text || null,
    trust_score: 0,
    status: 'active',
    available: false,
    service_areas: [],
...
async function createUser(payload) {
  const row = {
    ...
    line_picture_url: payload.line_picture_url || null,
    line_language: payload.line_language || null,
    default_address: payload.default_address || null,
    preferred_area: payload.preferred_area || null,
    available_time_text: payload.available_time_text || null,
